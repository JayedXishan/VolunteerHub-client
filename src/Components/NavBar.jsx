      ...
      <div className=" bg-[#EEF7FF]">
        <header className="lg:w-[1170px] mx-auto p-4">
          <div className="container flex justify-between items-center h-16 mx-auto">
            ...
            >
              <span className="text-[#4D869C] lg:text-5xl text-2xl ">
                VolunteerHub
              </span>
            </Link>
            <ul className="items-stretch hidden space-x-3 lg:flex text-gray-700 font-extralight ">
              <li className="flex">
                <Link
                  ...
                  className={
                    isActive === "1"
                      ? "text-[#4D869C] flex items-center px-4 border-b-2 border-[#4D869C] font-normal"
                      : "text-[#7AB2B2] flex items-center px-4 "
                  }
                >
                  Home
                </Link>
            ...
            <div className="">
              <label className="swap swap-rotate">
                ...
                {/* sun icon */}
                <svg
                  className="swap-off fill-current w-10 h-10  text-[#4D869C] "
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
                ...
                {/* moon icon */}
                <svg
                  className="swap-on fill-current w-10 h-10 text-[#4D869C]"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
